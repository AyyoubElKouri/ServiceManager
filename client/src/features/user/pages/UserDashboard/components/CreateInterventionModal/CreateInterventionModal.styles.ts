/**
 * @constant CREATE_INTERVENTION_MODAL_STYLES
 * @description Styling classes for the CreateInterventionModal component using modern dark palette
 */
export const CREATE_INTERVENTION_MODAL_STYLES = {
    ...
    checkboxGrid: 'grid grid-cols-1 md:grid-cols-3 gap-4 mb-6',
    checkbox: 'flex items-center space-x-2',
    checkboxInput:
        'w-4 h-4 text-blue-600 bg-slate-700 border-slate-600 rounded focus:ring-blue-500 focus:ring-2',
