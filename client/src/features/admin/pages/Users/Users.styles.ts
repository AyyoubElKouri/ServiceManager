/**
 * @constant USERS_STYLES
 * @description Styling classes for the Users component using modern dark palette
 */
export const USERS_STYLES = {
    ...
    retryButton:
        'px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200',
