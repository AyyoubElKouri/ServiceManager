/**
 * @constant STATISTICS_OVERVIEW_STYLES
 * @description Styling classes for the StatisticsOverview component using modern dark palette
 */
export const STATISTICS_OVERVIEW_STYLES = {
    container: 'mb-8',
